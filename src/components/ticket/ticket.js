...
export const Ticket = ({ ticket }) => {
    //console.log(format(add(new Date(`${ticket.departure_at}`), {minutes: ticket.duration})))
    //let arrival_at = add(new Date(`${ticket.departure_at}`), {minutes: ticket.duration})
    //console.log(format(add(new Date(`${ticket.departure_at}`), {minutes: ticket.duration}),"H':'mm"))
    return (
